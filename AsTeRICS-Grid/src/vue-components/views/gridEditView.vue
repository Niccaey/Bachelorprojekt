...
<script>
    ...
    import {GridActionEbook} from "../../js/model/GridActionEbook";
        ...
        methods: {
            ...
            newElement(type) {
                if (type === GridElement.ELEMENT_TYPE_NORMAL) {
                  ...
                  if (type === GridElement.ELEMENT_TYPE_EBOOK_READER) {
                    let openBook = new GridActionEbook({
                      action: GridActionEbook.actions.EB_OPEN
                    });
                    newElement.actions = [openBook];
                  }
    ...
    function initContextmenu() {
        ...
        var CONTEXT_NEW_EBOOK_READER = "CONTEXT_NEW_EBOOK_READER";
        ...
        function handleContextMenu(key, elementId) {
            switch (key) {
              ...
              case CONTEXT_NEW_EBOOK_READER: {
                vueApp.newElement(GridElement.ELEMENT_TYPE_EBOOK_READER);
                break;
              }
